  ...
  return (
    <div className="flex justify-center flex-col mt-12 items-center">
      {isMobileState?
          <>
            <div
                className="flex justify-center flex-col w-[20rem] sm:-mx-6 lg:-mx-6 border-4 rounded-md px-2 py-4">
              <button
                  className="bg-white mb-[1rem] hover:bg-red-500 hover:border-red-200 hover:text-red-200 text-red-400 font-semibold py-1 px-2 border border-red-400 rounded shadow whitespace-nowrap w-fit"
                  onClick={() => setAdd(true)}>
                요리 추가 +
              </button>
